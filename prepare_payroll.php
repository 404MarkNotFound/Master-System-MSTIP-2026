...
if(isset($_POST['btnProcess']) && !empty($payrollData)) {
    ...
    foreach($payrollData as $data) {
        $insertQuery = "INSERT INTO payroll (
            payroll_period, date_from, date_to, emp_num, lname, fname,
            position, days_worked, days_absent, late_count, rate_per_day,
            ...
            '{$data['emp_num']}', '{$data['lname']}', '{$data['fname']}',
            '{$data['position']}', {$data['days_worked']}, {$data['days_absent']}, 
